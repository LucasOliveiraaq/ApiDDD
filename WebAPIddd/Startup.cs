    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           options.UseSqlServer(
            ...
            services.AddDefaultIdentity<ApplicantionUser>(options => options.SignIn.RequireConfirmedAccount = false)
       ...
       .AddJwtBearer(option =>
       {
           option.TokenValidationParameters = new TokenValidationParameters
           {
               ...
               ValidIssuer = "Lucas.Securiry.Bearer",
               ValidAudience = "Lucas.Securiry.Bearer",

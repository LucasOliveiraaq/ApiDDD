...
using WebAPIddd.Models;
using WebAPIddd.Token;
...
namespace WebAPIddd.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public UsuarioController(IAplicacaoUsuario IAplicacaoUsuario, SignInManager<ApplicantionUser> signInManager,
            UserManager<ApplicantionUser> userManager)
        {
        ...
        public async Task<IActionResult> CriarToken([FromBody] Login login)
        {
            ...
            if (resultado)
            {
                ...
                .AddSubject("Empresa - LucasAprendizagem")
                .AddIssuer("Lucas.Securiry.Bearer")
                .AddAudience("Lucas.Securiry.Bearer")
